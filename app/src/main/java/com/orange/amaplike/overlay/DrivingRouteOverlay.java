...
public class DrivingRouteOverlay extends RouteOverlay {
    ...
    private static final int DRIVE_COLOR_DEFAULT = Color.parseColor("#537edc");
    private int driveColor = DRIVE_COLOR_DEFAULT;
    ...
    public int getDriveColor() {
        return driveColor == 0 ? DRIVE_COLOR_DEFAULT : driveColor;
    }
